#
#  Be sure to run `pod spec lint EasyLocalizedStrings.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Netsells" => "info@netsells.co.uk" }
  # Or just: s.author    = "Netsells"
  # s.authors            = { "Netsells" => "info@netsells.co.uk" }
  # s.social_media_url   = "http://twitter.com/Netsells"
